...
if (isset($_POST['update'])) {
	...
	if ($query) {
		echo "<script>alert('Địa chỉ nhận hàng has been updated');</script>";
	}
}
										...
										<td>
											<div class="form-group">
												...
												while ($row = mysqli_fetch_array($query)) {
													...
													<div class="form-group">
														<label class="info-title" for="Địa chỉ nhận hàng">Địa chỉ nhận
													...
													<div class="form-group">
														<label class="info-title" for="Billing Pincode">Mã bưu chính
															<span>*</span></label>
														<input type="text" class="form-control unicase-form-control text-input"
										...
										<td>
											<div class="form-group">
												...
												while ($row = mysqli_fetch_array($query)) {
													...
													<div class="form-group">
														<label class="info-title" for="Shipping State">Tỉnh/Thành phố giao
															hàng<span>*</span></label>
														<input type="text" class="form-control unicase-form-control text-input"
													...
													<div class="form-group">
														<label class="info-title" for="Shipping City">Thành phố giao
															hàng<span>*</span></label>
														<input type="text" class="form-control unicase-form-control text-input"
													...
													<div class="form-group">
														<label class="info-title" for="Shipping Pincode">Mã bưu chính giao
															hàng<span>*</span></label>
														<input type="text" class="form-control unicase-form-control text-input"
									...
									<tr>
										<td>
											<div class="cart-checkout-btn pull-right">
												<button type="submit" name="ordersubmit" class="btn btn-primary">TIẾN HÀNH
													THANH TOÁN</button>
											</div>
										</td>
									</tr>
