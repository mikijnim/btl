												...
												<div class="col-md-12 col-sm-12 already-registered-login">
													...
													while ($row = mysqli_fetch_array($query)) {
														...
														<form class="register-form" role="form" method="post">
															...
															<div class="form-group">
																<label class="info-title" for="Contact No.">Số điện thoại
																	<span>*</span></label>
																<input type="text"
																	class="form-control unicase-form-control text-input"
															...
															<button type="submit" name="update"
																class="btn-upper btn btn-primary checkout-page-button">Cập nhật
															</button>
														</form>
													<?php } ?>
									...
									<div id="collapseTwo" class="panel-collapse collapse">
										<div class="panel-body">
											<form class="register-form" role="form" method="post" name="chngpwd"
												...
												<div class="form-group">
													<label class="info-title" for="Current Password">Mật khẩu hiện
														tại<span>*</span></label>
													<input type="password"
												...
												<div class="form-group">
													<label class="info-title" for="Confirm Password">Xác nhận mật khẩu
														<span>*</span></label>
													<input type="password"
												...
												<button type="submit" name="submit"
													class="btn-upper btn btn-primary checkout-page-button">Thay đổi
												</button>
											</form>
										</div>
									</div>
