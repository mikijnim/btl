			...
			<div class="breadcrumb-inner">
				...
				while ($rw = mysqli_fetch_array($ret)) {
					...
					<ul class="list-inline list-unstyled">
						<li><a href="index.php">Trạng chủ</a></li>
													...
													while ($rvw = mysqli_fetch_array($qry)) {
														...
														<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
															<div class="review">
																...
																<div class="text"><b>Chất lượng :</b>
																	<?php echo htmlentities($rvw['quality']); ?> Sao</div>
																<div class="text"><b>Giá :</b>
																	<?php echo htmlentities($rvw['price']); ?> Sao</div>
																<div class="text"><b>Giá trị :</b>
																	<?php echo htmlentities($rvw['value']); ?> Sao</div>
														...
														<div class="review-form">
															<div class="form-container">
																<div class="row">
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label for="exampleInputName">Tên <span
																		...
																		<div class="form-group">
																			<label for="exampleInputSummary">Nội dung <span
																					class="astk">*</span></label>
																			<input type="text" class="form-control txt"
																...
																<div class="action text-right">
																	<button name="submit"
																		class="btn btn-primary btn-upper">Gửi đánh
																		giá</button>
																</div><!-- /.action -->
