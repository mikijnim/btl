...
if (isset($_POST['change'])) {
	...
	if ($num > 0) {
		...
		$uri = rtrim(dirname($_SERVER['PHP_SELF']), '/\\');
		header("location:http://$host$uri/$extra");
		$_SESSION['errmsg'] = "Email hoặc Số điện thoại liên hệ không hợp lệ";
		exit();
	}
}
?>
...
<head>
	...
	<title>Cửa hàng mua sắm | Quên mật khẩu</title>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 sign-in">
						...
						<form class="register-form outer-top-xs" name="register" method="post">
							...
							<div class="form-group">
								<label class="info-title" for="exampleInputPassword1">Số điện thoại liên hệ
									<span>*</span></label>
