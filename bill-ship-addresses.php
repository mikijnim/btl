													...
													while ($row = mysqli_fetch_array($query)) {
														...
														<form class="register-form" role="form" method="post">
															<div class="form-group">
																<label class="info-title" for="Địa chỉ nhận hàng">Địa chỉ
															...
															<div class="form-group">
																<label class="info-title" for="Billing State ">Tỉnh/Thành
																	phố<span>*</span></label>
																<input type="text"
															...
															<div class="form-group">
																<label class="info-title" for="Billing City">Quận/Huyện
																	<span>*</span></label>
																<input type="text"
																	class="form-control unicase-form-control text-input"
															...
															<div class="form-group">
																<label class="info-title" for="Billing Pincode">Mã bưu
																	điện<span>*</span></label>
																<input type="text"
																	class="form-control unicase-form-control text-input"
									...
									<div id="collapseTwo" class="panel-collapse collapse">
										<div class="panel-body">
											...
											while ($row = mysqli_fetch_array($query)) {
												...
												<form class="register-form" role="form" method="post">
													<div class="form-group">
														<label class="info-title" for="Shipping Address">Địa chỉ
															giao hàng<span>*</span></label>
